...
> I've used versions `2.47.1`, `v20.18.2` and `10.8.2` of git, Node.js and npm, respectively. I suggest you use the same or later LTS versions.
...
This project was created with 💚 by [Luiz]
